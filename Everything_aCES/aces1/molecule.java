...
public class molecule{
    ...
    */
    ...
    public boolean biSimple = false;
    
    public int biSimpleW = 0;    
    
    /*
    An array to store position information for a mutual information object, per residue of the molecule.
    First list is for the residue in molecule A
    ...
    */
    ...
    /*
    The lenght of the molecule
    */
    public int molSize;
    
    /*
    The name or ID of the molecule
    */
    public int molName;    
    
    /*
    Initialize the molecule object, the lenght of the sequence and the categories possible
    */
    public molecule(int len, String categories, int givenName){
    ...
    */
     ...
     * @param residue The residue of this molecule that experiences MI
     * @param molecule The interacting molecule
    ...
    /*
    A method to call for the category array for a molecule
    */
    ...
    /*
    A method to call for a residue array within a category for a molecule
    */
    ...
    */
    ...
    /*
    A method to call for the array of instances for a molecule
    */
    public int[][] getObs()
    {
        return obsA;
    ...
    */
    ...
    public void biSimpleSet(boolean tf, int W)
    {
        biSimple = tf;
        biSimpleW = W;
    }
 ...
 /**
    ...
    public int chooseResidue(int residueNo, int[] probSumT)
    {
                ...
                if(biSimple)
                {
                    ...
                    { 
                        if(obsA[residueNo][i] > obsA[residueNo][maxChoice])
                        {
                            maxChoice = i;
                        };
                    }
                    
                    //Set choice as a pick between random probability and observed count remaining.
                    int random100 = (int)Math.round(Math.random() * 100);           
        
                    if(random100 <= biSimpleW)
                     {
                      charChoice = maxChoice;
                     }
