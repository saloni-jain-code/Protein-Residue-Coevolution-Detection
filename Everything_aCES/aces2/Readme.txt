...
FOR ISMA
enter to run:
java --module-path "/Users/gabrielperez/Desktop/javafx-sdk-24/lib" --add-modules javafx.controls,javafx.fxml -jar aces2.jar


python renumber_fasta.py FULLPATH.txt renumbered.fasta
