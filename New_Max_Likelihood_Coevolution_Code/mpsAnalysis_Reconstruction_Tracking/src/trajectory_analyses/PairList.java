...
public class PairList {
    ...
    // Added by Amanda 
    public void trackPairsWithProvidedAncestors(Alignment myAlignment, TrieNode queryNode) throws Exception {
        @SuppressWarnings("rawtypes")
        ...
        while (iterator.hasNext()) {
            ...
            myParsimony.trackParsimonyChangesWithProvidedAncestors(
                myAlignment.columnsMap.get(pattern1),
                myAlignment.columnsMap.get(pattern2));
