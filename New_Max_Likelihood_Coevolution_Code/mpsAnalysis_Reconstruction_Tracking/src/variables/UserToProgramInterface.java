...
public class UserToProgramInterface {
    ...
    public void setIVariables() throws IOException {
        ...
        InternalVariables.ancestralFile = UserDefinedVariables.ancestralFile;
        // added by Amanda
        // if (UserDefinedVariables.ancestralFile != null) {
        //     InternalVariables.ancestralFile = UserDefinedVariables.ancestralFile;
        // } else {
        //     InternalVariables.ancestralFile = null;
        //     System.err.println("Error: Ancestral file not defined. Please check the control file.");
        // }
    ...
    private void setUDVariable(String flag, String value) {
        ...
        // added by Amanda
        } else if (flag.equalsIgnoreCase("ANCESTRAL_FILE")) {
            UserDefinedVariables.ancestralFile = value;
        } else {
            System.out.println("Error: Unknown flag in control file: " + flag);
        }
    }
}
